...
public class ATMDepositScreen extends Screen{
    private final JLabel imageLabel;
    private final Webcam webcam;

    public ATMDepositScreen(BufferedImage image, JLabel imageLabel, Webcam webcam) {
        super(image);
    ...
    public void start() {
        ...
        Button message = new NotClickableButton("Please deposit your checks.", new Point(300, 200), 800, 50, Color.BLACK);
