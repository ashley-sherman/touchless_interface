...
public class DrawTestMain {
    public static void main(String[] arguments) {
        ...
        ui.Button button = new ui.Button("A", new Point(100, 100), 75, 20, Color.PINK);
        //button.drawRegular(graphics);

        ui.Button button2 = new Button("B", new Point(300, 300), 50, 50, Color.GREEN);
        //button2.drawRegular(graphics);

        if (button2.inButton(new Point (305, 310))){
            System.out.println("In ui.Button");
        } else{
            System.out.println("not in button");
        }

        ui.Button button3 = new ui.Button("C", new Point(400, 250), 20, 70, Color.BLUE);
